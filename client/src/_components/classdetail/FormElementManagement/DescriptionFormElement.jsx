// components/FormElementManagement/DescriptionFormElement.jsx
...
function DescriptionFormElement({
    index,
    element,
    onChange,
    onDelete,
            ...
            <div>
                <Form.Item label="Mô Tả" style={{ marginBottom: 12 }}>
                    <ReactQuill
                        ...
                        onChange={(e) =>
                            onChange(index, [{ name: ['description'], value: e }])
                        }
                        rows={4}
                        modules={{  // Cấu hình toolbar (tùy chọn)
                            toolbar: [
